...
def starts2bed(data, outprefix):
    ...
    bed_file = outprefix + "_all_read_starts.bed" # alter output file suffix to include all reads rather than just known
...
def main():
   ...
   # data = data.loc[data.transcript_novelty == "Known"] # remove requirement for read to have known annotation
